<?php
/**
 * A Structures_Form element for one line of plain text entry.
 *
...
class Structures_Form_Element_Gtk2_SpinButton extends GtkSpinButton implements Structures_Form_ElementInterface {
     ...
     * @param  float   $min    The minimum value (optional, default = 0).
     * @param  float   $max    The maximum value
     *                         (optional, default = min + 100).
     * @param  float   $value  The default value (optional, default = min).
     * @param  float   $step   The step increment (optional, default = 1).
     * @param  float   $page   The page increment (optional, default = 5).
     * @param  float   $pSize  The page size (optional, default = 5).
     * @param  float   $rate   The climb rate (optional, defautl = 5).
     * @param  integer $digits The precision of the spin button.
     ...
     * @return void
     */
    public function __construct(Structures_Form $form, $label, $min = 0,
                                $max = null, $value = null, $step = 1,
                                $page = 5, $pSize = 5, $rate = 5, $digits = 2,
                                ...
                                )
    {
        ...
        parent::__construct(new GtkAdjustment($value, $min, $max, $step, $page,
                                              $pSize),
                            $rate, $digits
                            );
     ...
     *
     * @access public
     * @param  float   $value The value to put in the spinbutton.
    ...
    {
        // You can't clear the value of a spin button.
        return true;
    }
