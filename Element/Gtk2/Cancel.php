<?php
/**
 * A Structures_Form element for a cancel button. The cancel button clears the
 * form.
 *
...
class Structures_Form_Element_Gtk2_Cancel extends Structures_Form_Element_Gtk2_Button {
    ...
    public function __construct(Structures_Form $form, $label = '',
                                $text = Gtk::STOCK_CANCEL, $size = null,
                                $style = null)
    {
        // Call the parent constructor.
        parent::__construct($form, $label, $text, array($form, 'clearValues'),
                            $size, $style
                            );
    }
}
