<?php
/**
 * A Structures_Form element for a select style dropdown box for text values.
 *
...
class Structures_Form_Element_Gtk2_TextSelect extends Gtk2_IndexedComboBox implements Structures_Form_ElementInterface {
     ...
     * @param  array  $data  The default data (optional).
     * @param  string $value The default value (optional).
     ...
     * @return void
     */
    public function __construct(Structures_Form $form, $label, $data = null,
                                $value = null, $size = null, $style = null)
    {
    ...
    {
        return $this->setActiveKey($value);
    }
     ...
     *
     * It may not be possible to clear this element type. If no null key was
     * given, the element will not be cleared. Therefore, this method always
     * returns true regardless of whether or not the element was cleared.
     *
     * @access public
