<?php
/**
 * A Structures_Form element for a text area.
 *
...
class Structures_Form_Element_Gtk2_Textarea extends GtkTextView implements Structures_Form_ElementInterface {
    ...
    {
        return $this->get_buffer()->set_text($value);
    }
