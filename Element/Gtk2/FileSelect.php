<?php
/**
 * A Structures_Form element for selecting a file.
 *
...
class Structures_Form_Element_Gtk2_FileSelect extends GtkFileChooserButton implements Structures_Form_ElementInterface {
     ...
     * @param  string  $file   The default file (optional).
     * @param  integer $action The file chooser action (optional).
    ...
    public function setValue($value)
    {
        if (file_exists($value)) {
            if (is_dir($value)) {
                return $this->set_current_folder($value);
            } else {
    ...
    {
        return $this->setValue($this->fileAtConstruct);
    }
